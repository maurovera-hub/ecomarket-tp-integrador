...
└── docs/                     # Informe técnico y notas de integración
```
...
> **Nota:** si en tu máquina ya tenés un MySQL local corriendo en el puerto 3306, no hay conflicto: el contenedor se publica en el 3307 para evitarlo. Más detalle en `docs/notas-cors.md`.
...
El detalle de qué partes fueron generadas con asistencia de IA, y de qué manera, se encuentra documentado en el informe técnico (`docs/Informe_Tecnico_EcoMarket.pdf`), sección "Uso de Inteligencia Artificial".
 
## Documentación adicional
 
- `docs/Informe_Tecnico_EcoMarket.pdf` — Informe técnico completo (arquitectura, modelo de datos, diseño de API, integración, conclusiones).
- `docs/notas-cors.md` — Detalle del problema de CORS/conexión a MySQL encontrado durante la integración y su resolución.
